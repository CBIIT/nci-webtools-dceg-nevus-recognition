...
new CloudFrontS3Stack(app, `NevusToolStack-${TIER}`, {
  env: { account: AWS_ACCOUNT_ID, region },
  stackName: `${TIER}-nevustool-cloudfront-s3`,
  description: 'CloudFront and S3 infrastructure for Nevus Recognition Tool React application',
});
