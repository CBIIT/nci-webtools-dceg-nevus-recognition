...
export default function About() {
  return (
    <div className="container-xxl py-4">
      ...
      <p define-terms>
        The Moles to Melanoma Tool presents photographs in three main groups of
        pigmented lesions: <a href="#/view-cases?filter=mole">common moles</a>;{' '}
        <a href="#/view-cases?filter=dysplasticnevi">dysplastic nevi (DN)</a>;
        and <a href="#/view-cases?filter=melanoma">melanomas</a> that arose from
        DN.
      </p>
      <p define-terms>
      ...
      <p define-terms>
        Each case series shows changes in an individual pigmented lesion over a
        number of years and across the spectrum of changes typically seen in
      ...
      <p define-terms>
        ...
        their willingness to be photographed during skin examinations, and their
        generosity in allowing their pictures to be included in this resource.{' '}
      </p>
      <p define-terms>
        We would also like to thank John Crawford and Mary King,{' '}
        <span no-define>NIH Clinical Center</span> clinical photographers, for
        their expertise. The tool would not have been possible without the
        substantial commitment and cooperation of both the study participants
        and the clinical photographers.{' '}
      </p>
    </div>
  );
}
