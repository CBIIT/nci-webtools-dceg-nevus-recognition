        ...
        <Define>
          <ul>
            <li define-terms={true}>
              ...
              period. They show moles and melanomas from participants enrolled
              in the{' '}
              <a
            ...
            <li define-terms={true}>
              ...
              melanomas shown are not representative of those found in
              individuals with darker skin.
            </li>
            <li define-terms={true}>
              Melanomas and lesions suspicious for melanoma vary widely in
              appearance; these pictures should not be used to diagnose
              melanoma.
            </li>
            <li define-terms={true}>
